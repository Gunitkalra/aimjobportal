...
import '../model/updateskills&language_Model.dart';
import 'getProfile_Controller.dart';

class UpdateSkillsLanguageController extends GetxController {
  ...
  Future<void> updateSkillsAndLanguages({
    ...
    try {
      ...
      final url = Uri.parse("${ApiList.baseUrl}/v1/profile/skills");
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        final res = UpdateSkillsLanguageResponseModel.fromJson(json.decode(response.body));
        if (res.success == true) {
          showToastSuccess("Skills and languages updated successfully.");
      ...
      print("Update Skills and Languages Error: $e");
