...
import '../model/updateworkexperience_Model.dart';
import 'getProfile_Controller.dart';

class UpdateWorkExperienceController extends GetxController {
  ...
  Future<void> updateWorkExperience({
    ...
    try {
      ...
      final url = Uri.parse("${ApiList.baseUrl}/v1/profile/work-experience");
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        final res = UpdateWorkExperiencesResponseModel.fromJson(json.decode(response.body));
        if (res.success == true) {
          showToastSuccess("Work experience updated successfully.");
